...
const Gallery = () => {
  ...
  return (
    <div className="App ">
      <h1 className="my-10 font-semibold text-center lg:text-4xl md:text-3xl text-2xl">
        CheckOut this <span className="text-blue-600">Awesome</span> rooms
      </h1>
      <LightGallery
      ...
      >
        {images.map((image) => (
          <a className="max-w-[400px]" href={image.url}>
